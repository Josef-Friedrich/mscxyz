...
"""
__all__ = ['document_fromstring', 'fragment_fromstring', 'fragments_fromstring', 'fromstring', 'tostring', 'Element', 'defs', 'open_in_browser', 'submit_form', 'find_rel_links', 'find_class', 'make_links_absolute', 'resolve_base_href', 'iterlinks', 'rewrite_links', 'open_in_browser', 'parse']
XHTML_NAMESPACE = ...
_rel_links_xpath = ...
_options_xpath = ...
_forms_xpath = ...
...
class HtmlMixin:
    ...
    def iterlinks(self): # -> Generator[tuple[Unknown, Literal['codebase'], Unknown, Literal[0]] | tuple[Unknown, str, Unknown, Literal[0]] | tuple[Unknown, Literal['archive'], Unknown | str, int] | tuple[Unknown, Literal['content'], str | Any | Unknown, int | Unknown] | tuple[Unknown, Literal['value'], Unknown, Literal[0]] | tuple[Unknown, None, str | Any | int, str | Any | int] | tuple[Unknown, Literal['style'], str | Any, int], None, None]:
        """
...
class InputGetter:
    ...
    def __getitem__(self, name): # -> RadioGroup | CheckboxGroup | Any:
        ...
...
class SelectElement(InputMixin, HtmlElement):
    ...
    """
    @property
    def value(self): # -> MultipleSelectOptions | Any | str | None:
        """
...
class MultipleSelectOptions(SetMixin):
    ...
    def __iter__(self): # -> Generator[Any | str, None, None]:
        ...
