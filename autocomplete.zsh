...
_shtab_musescore_manager_options=(
  ...
  {-E,--extension}"[Extension to export. If this option is omitted, then the default extension is \"pdf\".]:export_extension:(mscz mscx spos mpos pdf svg png wav mp3 ogg flac mid midi kar musicxml xml mxl brf mei)"
