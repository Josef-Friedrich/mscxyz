...
_shtab_musescore_manager_options=(
  ...
  "--poet[Create a vertical frame (vbox) containing a poet text field and set the corresponding document properties poet field (metatag).]:meta_poet:"
  {--part-name,--instrument-excerpt}"[Create a vertical frame (vbox) containing a instrument_excerpt (part name) text field.]:meta_instrument_excerpt:"
