...
<museScore version="4.20">
  <Style>
    ...
    <pageEvenTopMargin>0.295276</pageEvenTopMargin>
    <pageEvenBottomMargin>0.393701</pageEvenBottomMargin>
    <pageOddTopMargin>0.295276</pageOddTopMargin>
    ...
    <minSystemDistance>9.8</minSystemDistance>
    ...
    <composerAlign>right,baseline</composerAlign>
    ...
    <lyricistFontFace>FreeSerifMscore</lyricistFontFace>
    ...
    <lyricistAlign>left,baseline</lyricistAlign>
    ...
    <stringNumberFramePadding>0</stringNumberFramePadding>
    <stringNumberFrameWidth>0</stringNumberFrameWidth>
    ...
    <dynamicsAlign>left,baseline</dynamicsAlign>
    ...
    <rehearsalMarkFramePadding>0</rehearsalMarkFramePadding>
    <rehearsalMarkFrameWidth>0</rehearsalMarkFrameWidth>
    ...
    <user1FontSize>13</user1FontSize>
    ...
    <user1Align>center,baseline</user1Align>
    <user1Offset x="0" y="0"/>
    ...
    <user2Name>Lyrics odd lines</user2Name>
    ...
    <user3Name>Lyrics even lines</user3Name>
    ...
    <user4Name>InstrumentsLong</user4Name>
    ...
    <user4Align>right,center</user4Align>
    <user4Offset x="0" y="0"/>
    ...
    <user5Name>InstrumentsShort</user5Name>
    <user5FontFace>MuseJazz Text</user5FontFace>
    <user5FontSize>12</user5FontSize>
    ...
    <user5Align>right,center</user5Align>
    <user5Offset x="0" y="0"/>
    ...
    <user6Name>InstrumentsExcerpt</user6Name>
    <user6FontFace>MuseJazz Text</user6FontFace>
    <user6FontSize>18</user6FontSize>
    ...
    <user6Align>left,bottom</user6Align>
    <user6Offset x="0" y="0"/>
